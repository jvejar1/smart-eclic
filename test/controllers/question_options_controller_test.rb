...
class QuestionOptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_option" do
    assert_difference('QuestionOption.count') do
      post question_options_url, params: { question_option: { correct: @question_option.correct, option_text: @question_option.option_text, question_id: @question_option.question_id } }
    end
  ...
  test "should update question_option" do
    patch question_option_url(@question_option), params: { question_option: { correct: @question_option.correct, option_text: @question_option.option_text, question_id: @question_option.question_id } }
